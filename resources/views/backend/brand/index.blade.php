        ...
        <div class="content-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Games List <a href="{{route('brand.create')}}" class="btn btn-success" style="float: right"><i class="fa fa-plus-circle"></i> Add new Game </a></h4>
                            <p class="card-description">
                                Total Games : {{\App\Models\Brand::count()}}
                            </p>

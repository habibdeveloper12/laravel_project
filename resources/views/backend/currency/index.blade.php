        ...
        <div class="content-wrapper">
            <div class="row">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Currency List <a href="{{route('currency.create')}}" class="btn btn-success" style="float: right"><i class="fa fa-plus-circle"></i> Create Currency </a></h4>
                            <p class="card-description">
                                Total Currencies :{{\App\Models\Currency::count()}}
                            </p>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($currencies as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('currency.edit',$item->id)}}" class="float-left btn btn-sm btn-outline-warning" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>

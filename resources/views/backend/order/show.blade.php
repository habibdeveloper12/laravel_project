                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive pt-3">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>{{ucfirst($order->username)}}</td>
                                            <td>{{ucfirst($seller->username)}}</td>
                                            <td>{{ucfirst($order->product)}}</td>
                                            <td>{{ucfirst($order->quantity)}}</td>
                                            <td>{{Helper::currency_converter($order->product_price)}}</td>
                                            <td>{{ucfirst($order->payment_status)}}</td>
                                            <td>{{Helper::currency_converter($order->total)}}</td>
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <form action="{{route('order.status')}}" method="post">
                                    ...
                                    <select name="condition" class="form-control mt-1">
                                        ...
                                        <option value="cancelled"  {{$order->condition  == 'cancelled'? 'selected' : ''}}>Cancel and Refund</option>
                                    </select>

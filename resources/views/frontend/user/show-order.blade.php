    ...
    <div class="content">
        <div class="container ord">
            ...
            <div class="row justify-content-between" >
                <div class="col-3 back-to">
                    <a href="{{route('user-order.index')}}"><i class="fa fa-arrow-left"></i> Back <span class="no">to order page</span></a>
                </div>

                <div class="col-6">
                    <h3 class="ml-sm-1" style="text-align:center; margin: 15px 0; font-size: 22px; ">View Order</h3>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-6 ">
                <div class="col-12">
                    <h3 class="text-center"> Order #{{$order->order_number}}</h3>
                </div>
                ...
                <div class="col-12 text-center">
                    ...
                    <form action="{{route('user-order.update', $order->id)}}" method="POST" >
                        ...
                        @if($order->condition == 'completed')
                            ...
                            <div class="rec"> <span class="fa fa-check" style="font-size: 20px"></span> ORDER COMPLETED</div>
                           <div>
                               @if(!$reviewed)<br> <p style="font-size: 20px"> Please review the seller below!</p>@endif
                           </div>
                        @elseif($order->condition == 'cancelled')
                            ...
                            <div class="rec"> SELLER CANCELLED AND REFUNDED YOUR ORDER</div>
                        @else
                        <button type="submit" class="cfmBtn btn btn-warning"> CONFIRM ORDER RECEIVED</button>
                        @endif
                    </form>
                    ...
                    @else
                        <p style="font-size: 15px">If seller is not responding, or you have any issue after you bought an item</p>
                                        ...
                                        @auth
                                                <form action="{{route('user.review', $seller->user_id)}}" method="post" id="commentform" class="comment-form" novalidate="">
                                                    ...
                                                    <div class="comment-form-rating pb-5">
                                                        <span>Seller rating </span><span style="color: red; font-size: 18px">*</span>
                                                        <p class="stars">
                                                    ...
                                                    <p class="comment-form-comment">
                                                        <label for="comment">Seller review
                                                        </label>
                                        ...
                                        <div id="respond" class="comment-respond">
                                            @auth
                                                <form action="{{route('user.review.update', $seller->user_id)}}" method="post" id="commentform" class="comment-form" novalidate="">
                                                    ...
                                                    <p class="comment-form-comment">
                                                        <label for="comment">Seller review  </label>
                            ...
                            <ol class="commentlist">
                                        <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                            <div id="comment-20" class="row comment_container">
                                                <div class="col-3" style="background-image: url('{{$user->photo == null ? Helper::userDefaultImage() : $user->photo}}');

...
>
    ...
    <tr>
        <td>
            <div>
                <span style="font-size: 24px; line-height: 32px; color: #000000; font-weight: bolder;">Email Change Verification</span>
            </div>
        </td>
    </tr>
    <tr>
        <td style="background-color: #f6e079;" width="24">
            ...
            >
                ...
                <tr>
                    <td>
                        <p style="font-size: 14px; line-height: 20px;">Hello, You requested to change your email address to {{$email_data['email']}}. Click the link below to change your mail</p>
                    </td>
                </tr>
                <tr>
                    <td style="display: flex; justify-content: center;">
                        @if($email_data['route'] == 'http://127.0.0.1:8000')
                            <a style="color: dodgerblue;" href="http://127.0.0.1:8000/verify-email?code={{$email_data['verification_code']}}">
                                http://127.0.0.1:8000/verify-email?code={{$email_data['verification_code']}}
                            </a>
                        @else
                            <a style=" color: dodgerblue;" href="https://gg-trade.com/-email?code={{$email_data['verification_code']}}">
                                https://gg-trade.com/-email?code={{$email_data['verification_code']}}
                            </a>
                        @endif
                    </td>
                </tr>

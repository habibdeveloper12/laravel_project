...
>
    ...
    <tr>
        <td>
            <div>
                <span style="font-size: 24px; line-height: 32px; color: #000000; font-weight: bolder;">Order Delivered </span>
            </div>
        </td>
    </tr>
    <tr>
        <td style="background-color: #f6e079;" width="24">
            ...
            >
                ...
                <tr>
                    <td>
                        <p style="font-size: 14px; line-height: 20px;">Your order with ID <strong> #{{$email_data['order_number']}} </strong> has been delivered. Check your order by clicking the link below</p>
                    </td>
                </tr>
                <tr>
                <tr>

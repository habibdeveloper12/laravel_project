    ...
    <tr>
        <td style="background-color: #f6e079;" width="24">
            ...
            >
                ...
                <tr>
                    <td>
                        <p style="font-size: 14px; line-height: 20px;">Your order with ID <strong> #{{$email_data['order_number']}} </strong> has been completed. </p>
                    </td>
                ...
                <tr>
                    <td>
                        ...
                        <br/>
                        <p style="font-size: 14px; line-height: 20px;">Also give the Seller a review on the order page.</p>

...
>
    ...
    <tr>
        <td>
            <div>
                <span style="font-size: 24px; line-height: 32px; color: #000000; font-weight: bolder;">Order Completed </span>
            </div>
        </td>
    </tr>
    <tr>
        <td style="background-color: #f6e079;" width="24">
            ...
            >
                ...
                <tr>
                    <td>
                        <p style="font-size: 14px; line-height: 20px;">Hurrah 🎉 {{$email_data['name']}},</p>
                    </td>
                </tr>

                <tr>
                    <td>
                        <p style="font-size: 14px; line-height: 20px;">Your order with ID <strong> #{{$email_data['order_number']}} </strong> has been confirmed by the buyer. Your fund is now in your wallet! It will be available for withdrawal in 24hrs</p>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <p style="font-size: 14px; line-height: 20px;">Don't forget to give us a review on <a style="color: dodgerblue; word-break: break-all; text-decoration: none;" href="https://www.trustpilot.com/review/gg-trade.com?utm_medium=trustbox&utm_source=MicroReviewCount">Trustpilot</a>, Thanks.</p>
                        <br/>
                        <p style="font-size: 14px; line-height: 20px;">Also give the Buyer a review on the order page.</p>

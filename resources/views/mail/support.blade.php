...
>
    ...
    <tr>
        <td>
            <div>
                <span style="font-size: 24px; line-height: 32px; color: #000000; font-weight: bolder;">Ticket number - #{{$email_data['ticket_num']}} </span>
            </div>
        </td>
    </tr>
    <tr>
        <td style="background-color: #f6e079;" width="24">
            ...
            >
                ...
                <tr>
                    <td>
                        <p style="font-size: 14px; line-height: 20px;">We have received your request with Ticket ID #{{$email_data['ticket_num']}}. We will contact you shortly.</p>
                    </td>
                </tr>
                <tr>
                    <td>
